...
이 섹션에서는 VLM(Vision-Language Model) 분야에서 중요한 이정표가 된 모델들을 시대 순으로, 그리고 계보별로 정리합니다. 각 모델의 핵심 혁신이 무엇인지, 왜 중요한지에 집중합니다. 2026년 2월 기준 최신 동향을 포함합니다.
...
CLIP은 현대 VLM 생태계의 **근간**을 형성한 모델입니다.
...
**영향**: CLIP이 없었다면 현재의 VLM 발전 속도는 훨씬 느렸을 것입니다. 대부분의 오픈소스 VLM이 CLIP ViT-L/14를 Visual Encoder로 사용했습니다.
...
멀티모달 분야에서 GPT-3에 비견될 수 있는 **기념비적인 모델**입니다.
...
오픈소스 VLM 연구의 흐름을 바꾼 **게임 체인저**입니다.
...
InternVL은 현재 **오픈소스 VLM 중 가장 강력한 계보** 중 하나입니다.
